...
function App() {
  ...
  return (
    <>
      <SEO title='JavaScript Playground Online – Run, Test & Debug JS Code Instantly' 
      description='Free online JavaScript playground to write, run and test JavaScript code instantly. Debug JS, test snippets, and experiment with JavaScript in your browser.'
      type='website'
